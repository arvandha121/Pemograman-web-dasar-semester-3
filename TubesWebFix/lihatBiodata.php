    ...
    <div class="row-xxl-4">
        <div class="col-xxl-4">
            <nav class="navbar navbar-expand-xl navbar-dark bg-primary shadow fixed-top">
                <div class="container">
                    <a class="navbar-brand" style="font-weight: bold" href="guest.php">NAVBAR</a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" aria-disabled="true" href="tambah.php" tabindex="-1">Daftar</a>
                        </li>
                    </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="mb-3">
                    <nav>
                        <a class="nav-link disabled" style="text-decoration: none;" href="tambah.php?tambah-daftar-baru">
                            <button type="button" class="btn btn-primary" disabled>Tambah Baru</button>
                        </a>
                    </nav>
                </div>
                <div class="mb-3">
                        ...
                        <tbody>
                            <?php 
                                ...
                                while($siswa = mysqli_fetch_array($query)){
                                    ...
                                    echo "<td>";
                                    echo "<a style='text-decoration: none;' href=' cetakguest.php?id=" .$siswa['id']. " '><button type='button' class='btn btn-info ml-1'>Print</button></?a>";
                                    echo "</td>";
