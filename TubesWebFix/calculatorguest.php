...
<body style="background: #269aff;">
   <!-- Navbar -->
   <nav class="navbar navbar-light text-light bg-primary">
    ...
    <!-- Akhir Nama dan Nim  -->
   <div class="container" style="width: 60%; height: auto; weight: bold;"">
       <div class="row">
           <div class="col">
            <div class="container" style="padding: 35px;border: 1px solid grey;margin-top: 50px;background: whitesmoke; box-shadow: 5px 5px #525252; border-radius: 10px;">
                <div class="row">
            ...
            <a href="guest.php"><button class="btn btn-danger float-right" style="margin-top: 2rem; margin-bottom: 5rem">Kembali</button></a>
           </div>
       </div>
   </div>
